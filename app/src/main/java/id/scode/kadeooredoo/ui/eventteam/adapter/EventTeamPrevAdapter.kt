 ...
 * Created on 27 12/27/19 6:22 AM 2019
...
class EventTeamPrevAdapter(
    private val context: Context,
    private var items: List<EventPrevious>,
    private val listener: (EventPrevious) -> Unit
) : RecyclerView.Adapter<EventTeamPrevAdapter.ViewHolder>(), Filterable,
    ...
    override fun showTeamList(
        ...
        holderEventTeamPrevAdapter: ViewHolder?,
        ...
        data?.let {
            ...
            for (i in mutableListEventPrevOne.indices)
                reBindingAnEvent(
                    ...
                    listTeam = it,
                    forIterate = i,
                    viewHolder = holderEventTeamPrevAdapter,
    ...
    companion object {
        val TAG_LOG = EventTeamPrevAdapter::class.java.simpleName
    }
}